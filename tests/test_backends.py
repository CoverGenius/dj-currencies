...
class OpenExchangeRateBackendTestCase(TransactionTestCase):
    ...
    def test_backend_generates_correct_url(self):
        ...
        self.assertEqual("https://openexchangerates.org/api/latest.json?app_id=APP_ID&base=AUD",
                         url)
    ...
    def test_get_latest_cached_rates__one_symbol(self):
        ...
        self.assertDictEqual(get_latest_cached_rates(['USD']), {
            'USD': {
                'AUD': 1.6,
                'EUR': 0.9
            }
    ...
    def test_get_latest_cached_rates__multiple_symbols(self):
        ...
        self.assertDictEqual(get_latest_cached_rates(['USD', 'NZD']), {
            'USD': {
                'AUD': 1.6,
                'EUR': 0.9
            },
